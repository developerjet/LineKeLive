...
+(UIColor *)colorThemeColor{
    ...
    return [UIColor colorWithRed:251/255.0 green:182/255.0 blue:94/255.0 alpha:1];
}

//用主题色导致色差明显
+ (UIColor *)colorNavThemeColor
{
    //return [UIColor colorWithRed:236/255.0 green:185/255.0 blue:103/255.0 alpha:1];
    return [UIColor colorWithRed:0/255.0 green:216/255.0 blue:201/255.0 alpha:1];
}
...
+ (UIColor *)colorBackGroundWhiteColor{
...
//    return [UIColor colorWithRed:85/255.0 green:210/255.0 blue:32/255.0 alpha:1];
